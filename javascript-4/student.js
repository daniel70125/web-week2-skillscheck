...
const faveColors = ["Red", "Grey", "Black"];
...
const me = {
    firstName: "Daniel",
    superHeroName: "Hou-Daniel",
    homeTown: "New Orleans",
    superPowers: ["Teleportation", "Telepathy", "Superhuman Strength"],
...
const setColor = arr => {
    ...
    for (let i = 0; i < splicedArr.length; i++) {
        let elm = splicedArr[i];
        if (elm === "blue"){
            elm = '#4D4DFF'
        }
    }
    background(...splicedArr);
}
